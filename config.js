...
var config ={
    ...
    */
    ...
    clientid : '1fa1a752-6580-4776-84df-1cc3823d4ae5',//client id created in Azure AD
    replyurl : 'https://itgsamplehealth1.azurewebsites.net/',//replyurl you set in Azure AD
    appName : 'itgsamplehealth1'//Application Name registered in Azure AD
};
